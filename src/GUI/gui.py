...
class Ui_AwAI(object):
    def setupUi(self, AwAI):
        ...
        self.nbGraines2 = QtWidgets.QLCDNumber(self.centralwidget)
        self.nbGraines2.setObjectName("nbGraines2")
        self.gridLayout_2.addWidget(self.nbGraines2, 1, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_2, 1, 0, 1, 1, QtCore.Qt.AlignLeft)
        self.nbGraines1 = QtWidgets.QLCDNumber(self.centralwidget)
        self.nbGraines1.setObjectName("nbGraines1")
        self.gridLayout_2.addWidget(self.nbGraines1, 1, 1, 1, 1)
